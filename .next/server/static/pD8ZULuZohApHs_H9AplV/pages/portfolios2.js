...
/* harmony default export */ var portfoliocarddetail = (portfoliocarddetail_PortfolioCardDetail);
...
/*#__PURE__*/
function (_Component) {
  portfoliocard_inherits(PortfolioCard, _Component);
  ...
  portfoliocard_createClass(PortfolioCard, [{
    ...
    value: function render() {
      ...
      }, external_react_default.a.createElement(portfoliocarddetail, {
      ...
      }, item.position), external_react_default.a.createElement(external_reactstrap_["CardBody"], null, external_react_default.a.createElement("p", {
        className: "portfolio-card-city"
      }, item.location, " "), external_react_default.a.createElement(external_reactstrap_["CardTitle"], {
        className: "portfolio-card-title"
      }, item.title), external_react_default.a.createElement(external_reactstrap_["CardText"], {
        className: "portfolio-card-text"
      }, item.description), external_react_default.a.createElement("div", {
        className: "readMore"
      }, children))));
    }
  }]);
...
/* harmony import */ var _components_portfolios_portfoliocard__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(28);
...
/*#__PURE__*/
function (_React$Component) {
  _inherits(Portfolios2, _React$Component);

  function Portfolios2(props) {
    var _this;

    _classCallCheck(this, Portfolios2);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(Portfolios2).call(this, props));
    _this.renderPortfolios = _this.renderPortfolios.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    return _this;
  }
  ...
  _createClass(Portfolios2, [{
    ...
    value: function navigateToEdit(portfolioId, e) {
      e.stopPropagation();
      _routes__WEBPACK_IMPORTED_MODULE_7__["Router"].pushRoute("/portfolio/".concat(portfolioId, "/edit"));
    }
  }, {
    key: "displayDeleteWarning",
    value: function displayDeleteWarning(portfolioId) {
    ...
    value: function deletePortfolio(portfolioId) {
      Object(_actions__WEBPACK_IMPORTED_MODULE_6__[/* deletePortfolio */ "d"])(portfolioId).then(function () {
    ...
    value: function renderPortfolios(portfolios) {
      ...
      return portfolios.map(function (item, index) {
        return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(reactstrap__WEBPACK_IMPORTED_MODULE_5__["Col"], {
          md: "4",
          key: index
        }, react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_components_portfolios_portfoliocard__WEBPACK_IMPORTED_MODULE_8__[/* default */ "a"], {
          item: item
    ...
    value: function render() {
      ...
      return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_components_layout_BaseLayout__WEBPACK_IMPORTED_MODULE_2__[/* default */ "a"], _extends({
        cannonical: "/portfolios"
      }, this.props.auth, {
        title: "Debdut saha - Newest Portfolios"
      }), react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_components_BasePage__WEBPACK_IMPORTED_MODULE_3__[/* default */ "a"], {
        title: "Portfolios",
        ...
        color: "success",
        onClick: function onClick() {
          _routes__WEBPACK_IMPORTED_MODULE_7__["Router"].pushRoute('/portfolios/new');
        },
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _context.prev = 2;
                _context.next = 5;
                return Object(_actions__WEBPACK_IMPORTED_MODULE_6__[/* getPortfolios */ "i"])(req);
