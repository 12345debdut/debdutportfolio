...
var external_slate_react_ = __webpack_require__(22);
...
var external_react_emotion_ = __webpack_require__(19);
...
var external_slate_html_serializer_ = __webpack_require__(24);
...
/* harmony import */ var _components_slateEditor_Editor__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(26);
/* harmony import */ var _actions__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(14);
/* harmony import */ var _routes__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(3);
/* harmony import */ var _routes__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(_routes__WEBPACK_IMPORTED_MODULE_6__);
/* harmony import */ var react_toastify__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(21);
...
/*#__PURE__*/
function (_React$Component) {
  _inherits(BlogEditor, _React$Component);
  ...
  function BlogEditor(props) {
    ...
    _this.saveBlog = _this.saveBlog.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    return _this;
  }

  _createClass(BlogEditor, [{
    key: "saveBlog",
    value: function saveBlog(story, heading) {
      var _this2 = this;
      ...
      Object(_actions__WEBPACK_IMPORTED_MODULE_5__[/* createBlog */ "a"])(blog, lockId).then(function (createdBlog) {
        react_toastify__WEBPACK_IMPORTED_MODULE_7__["toast"].success('Blog is saved successfully');

        _this2.setState({
          isSaving: false
        });

        _routes__WEBPACK_IMPORTED_MODULE_6__["Router"].pushRoute("/blogs/".concat(createdBlog._id, "/edit"));
      }).catch(function (err) {
        _this2.setState({
          isSaving: false
        });

        var message = err || 'Server Error';
    ...
    value: function render() {
      ...
      }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_components_slateEditor_Editor__WEBPACK_IMPORTED_MODULE_4__[/* default */ "a"], {
        isLoading: isSaving,
        save: this.saveBlog
      })));
    }
...
/* harmony default export */ __webpack_exports__["default"] = (Object(_components_hoc_withAuth__WEBPACK_IMPORTED_MODULE_3__[/* default */ "a"])('admin')(BlogEditor));
