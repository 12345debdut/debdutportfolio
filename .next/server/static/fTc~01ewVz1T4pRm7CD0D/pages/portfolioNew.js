      ...
      function (_React$Component) {
        ...
        _createClass(withAuth, [{
          ...
          value: function renderProtectedPage() {
            ...
            var userRole = user && user["".concat("https://debdutsahaportfolio.herokuapp.com", "/roles")];
...
var axiosInstance = axios__WEBPACK_IMPORTED_MODULE_1___default.a.create({
  baseURL: "".concat("https://debdutsahaportfolio.herokuapp.com", "/api/v1"),
  timeout: 3000
});
...
var external_formik_ = __webpack_require__(18);
...
var input_PortInput = function PortInput(_ref) {
...
function (_Component) {
  ...
  function PortDate(props) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "handleChange", function (dateValue) {
    ...
    var _dateValue = props.initialDate ? external_moment_default()(props.initialDate) : external_moment_default()();
  ...
  _createClass(PortDate, [{
    ...
    value: function render() {
      ...
      }, "disable"), canBeDisabled && isHidden && external_react_default.a.createElement(external_reactstrap_["Button"], {
        onClick: function onClick() {
          _this2.toggle(dateValue);
        }
      }, "Enable"), touched[field.name] && errors[field.name] && external_react_default.a.createElement("div", {
        className: "error"
      }, errors[field.name]));
    }
  }]);
...
// CONCATENATED MODULE: ./components/portfolios/portfolioForm.js
// Render Prop
...
var portfolioForm_validateInput = function validateInput(values) {
  var errors = {};
  Object.keys(values).forEach(function (key) {
    if (key !== "enddate") {
      if (!values[key]) {
        errors[key] = "Field ".concat(key, " is reqired!");
      }
    }
  });
...
var portfolioForm_PortFolioCreateForm = function PortFolioCreateForm(props) {
  return external_react_default.a.createElement("div", null, external_react_default.a.createElement(external_formik_["Formik"], {
    ...
    validate: portfolioForm_validateInput,
    ...
    return external_react_default.a.createElement(external_formik_["Form"], null, external_react_default.a.createElement(external_formik_["Field"], {
      ...
      name: "startdate",
      label: "Startdate",
      initialDate: props.initialValues.startdate ? props.initialValues.startdate : external_moment_default()(),
      ...
      component: Portdate_PortDate,
      canBeDisabled: true
    }), props.error && external_react_default.a.createElement(Alert, {
      color: "danger"
    }, props.error), external_react_default.a.createElement(external_reactstrap_["Button"], {
      outline: true,
      color: "warning",
      size: "lg",
      type: "submit",
...
/* harmony default export */ var portfolioForm = __webpack_exports__["a"] = (portfolioForm_PortFolioCreateForm);
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(0);
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _components_layout_BaseLayout__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(5);
/* harmony import */ var _components_BasePage__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(6);
/* harmony import */ var _components_hoc_withAuth__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(13);
/* harmony import */ var _components_portfolios_portfolioForm__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(27);
/* harmony import */ var reactstrap__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(1);
/* harmony import */ var reactstrap__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(reactstrap__WEBPACK_IMPORTED_MODULE_5__);
/* harmony import */ var _routes__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(3);
/* harmony import */ var _routes__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(_routes__WEBPACK_IMPORTED_MODULE_6__);
/* harmony import */ var moment__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(16);
/* harmony import */ var moment__WEBPACK_IMPORTED_MODULE_7___default = /*#__PURE__*/__webpack_require__.n(moment__WEBPACK_IMPORTED_MODULE_7__);
/* harmony import */ var _actions_index__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(14);
function _typeof(obj) { if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }
...
var INITIALVALUES = {
  ...
  description: '',
  startdate: '',
  enddate: moment__WEBPACK_IMPORTED_MODULE_7___default()()
};
...
function (_React$Component) {
  ...
  function PortfolioNew(props) {
    ...
    _this.savePortfolio = _this.savePortfolio.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    return _this;
  }
  ...
  _createClass(PortfolioNew, [{
    ...
    value: function savePortfolio(portfolioData, _ref) {
      ...
      setSubmitting(true);
      Object(_actions_index__WEBPACK_IMPORTED_MODULE_8__[/* createPortfolio */ "b"])(portfolioData).then(function (portfolio) {
        setSubmitting(false);
        _routes__WEBPACK_IMPORTED_MODULE_6__["Router"].pushRoute('/portfolios');
      }).catch(function (err) {
        setSubmitting(false);
    ...
    value: function render() {
      ...
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_components_layout_BaseLayout__WEBPACK_IMPORTED_MODULE_1__[/* default */ "a"], this.props.auth, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_components_BasePage__WEBPACK_IMPORTED_MODULE_2__[/* default */ "a"], {
        ...
        md: "6"
      }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_components_portfolios_portfolioForm__WEBPACK_IMPORTED_MODULE_4__[/* default */ "a"], {
...
/* harmony default export */ __webpack_exports__["default"] = (Object(_components_hoc_withAuth__WEBPACK_IMPORTED_MODULE_3__[/* default */ "a"])('admin')(PortfolioNew));
